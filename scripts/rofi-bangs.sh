...
LABELS["clipboard"]="clipboard"

# Calculator
COMMANDS["calc"]='rofi -show calc -modi calc -no-show-match -no-sort -calc-command "echo '{result}' | xclip -selection c"'
LABELS["calc"]="calc"

# Filebrowser
COMMANDS["filebrowser"]='rofi -show file-browser-extended'
...
# rofi-emoji
COMMANDS["emoji"]='rofi -show emoji'
LABELS["emoji"]="rofiemoji"
